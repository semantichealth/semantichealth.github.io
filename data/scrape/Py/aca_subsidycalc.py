...
@module:  aca_subsidycalc
@desc :   This module computes ACA subsidy cap based on 
	  income, number of members in household.
	  See: http://www.valuepenguin.com/understanding-aca-subsidies
	  This will be plugged into the Flask Searchkit to calculate subsidy
	  user input.
"""
